...
## 术语表
	...
	VIP成长值：用户成为VIP会员后，拥有对应的VIP成长值，每天成长10点，若用户VIP到期不续费，则成长值每天下降8点。成长值达到100点升级为2级VIP、达到500点升级3级VIP、达到1000点升级为4级VIP、达到5000点升级为5级VIP。

## 用例列表（带有使用情况细节）
	
	A1：游客浏览
	前置条件：无
	1、游客浏览所有个人社区的内容（包括文章、视频、直播、其他用户的群聊记录），该内容被社长设定为游客允许浏览
	后置条件：无
	...
	B2：用户浏览
	前置条件：已经登录（A3）
	1、用户浏览所有个人社区的内容（包括文章、视频、直播、其他用户的群聊记录），该内容被社长设定为该等级用户允许浏览
	后置条件：允许用户评论、收藏、转发
	...
	B17：用户VIP升级/降级
	前置条件：已经登录并充值购买VIP会员
	1、成长值达到100点升级为2级VIP、达到500点升级3级VIP、达到1000点升级为4级VIP、达到5000点升级为5级VIP
	后置条件：
	...
	D12：社长勾选发布内容阅读权限
	前置条件：已经登录
	1、社长在发布文章或视频教程内容时、可设定指定等级以上的用户才可阅读此内容
	后置条件：
